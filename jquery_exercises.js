...
// $(document).ready(function(){
// 	$('#target span').css('float','left');
// 	$('#target').height('200px').width('200px');
// 	var secondElement = $('#target span').clone();
// 	$('#target span').after(secondElement)
// });
...
// $(document).ready(function(){
// 	$('.target').eq(1).css('background-color','#c0c0c0')
// });
...
// $(document).ready(function(){
// 	$('select option:nth-child(2)').css('color','red')
// });
...
// window is an object; represents and open window in a browser
